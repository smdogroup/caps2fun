...
class WingOptimizer():
    ...
    def __init__(self, DVdict):
        ...
        #used DVs
        self.usedDVs = ["area","aspect","camb0","cambf","ctwist", "dihedral","lesweep", "taper","tc0","tcf","thick1", "thick2", "thick3","thick4","thick5","thick6", "thick7","thick8","thick9"]
    ...
    def writeInput(self, x):
        ...
        functions = ["ksfailure","mass","cl","cd"]
